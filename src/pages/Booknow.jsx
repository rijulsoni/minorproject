            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                        ...
                        <div>
                            <form action='https://formspree.io/f/mbjerqko' method="POST"> 
                            <div className="row my-3">
                                <div className="col-md-6 col-12">
                                    <div className="form-group">
                                        
                                            <label htmlFor="Fromdate" className="font-weight-bolder mr-3">From Date </label>
                                            <DatePicker name='from ' selected={this.state.startDate} onChange={this.handleChangeStart} className="form-control" />
                                    </div>
                                </div>
                                <div className="col-md-6 col-12">
                                    <div className="form-group">
                                        <label htmlFor="Todate" className="font-weight-bolder mr-3">To Date </label>
                                        <DatePicker name='to' selected={this.state.endDate} onChange={this.handleChangeEnd} className="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div className='row'>
                                <div className="col-md-6 col-12">
                                    <span className="font-weight-bolder"><b>Name: </b></span>
                                    <input type='text' placeholder='Your Full Name' name='name'/>
                                   </div>
                                   <div className="col-md-6 col-12">
                                   <span className="font-weight-bolder"><b>Contact Number: </b></span>
                            ...
                            <div className="row my-4">
                                ...
                                <div className="col-md-6 col-12 my-auto">
                                    <div className="col-md-6 col-12 float-right">
                                        <button className="btn btn-block btn-outline-primary" data-toggle="modal" data-target='#thanks' name='confirm'>Confirm Booking</button>
                                    </div>
                                </div>
                            </div>
                            </form>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-secondary" name='close' data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
